...
- **1.46.0** & **1.29.0-lite** (sqlite version will no longer be updated): Version 1 is a prototype release for creating and sharing open roadmaps, with editing protected by password lock.
- **2.8.0**: Version 2 is a prototype release with oidc & trusted-header for user membership that replace the password lock in v1.
