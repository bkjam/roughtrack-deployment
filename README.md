...
- **1.36.0** & **1.29.0-lite** (sqlite version will no longer be updated): Version 1 is a prototype release for creating and sharing open roadmaps, with editing protected by password lock.
